...
class GenerateTransaction(Event):
    ...
    def __init__(self, time, peer1ID, peer2ID, amount, isinvalid):
        self.time = time
    ...
    def process(self):
        ...
        txn = Transaction(self.peer1ID, self.peer2ID, self.amount, self.isinvalid)
        # if loggingTxn:
        ...
        pq.put((recTime, next(unique), GenerateTransaction(recTime, self.peer1ID, peer2ID, amount, isinvalid)))
